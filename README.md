...
|:--------------:|:--------------------:|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  Nov 06th, 2018 | Library Meeting Room | Created BitBucket repositories and base package for SRS [NM]. Included procedures to display table tuples [VM]. Implementation of procedure to get TA details using classid [DP].                      |
